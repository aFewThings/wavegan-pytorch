...
if __name__ == "__main__":
    ...
    train_loader = MyWavDataLoader(target_signals_dir, pick_species=pick_species, is_train=True)
    val_loader = MyWavDataLoader(target_signals_dir, pick_species=pick_species, is_train=False)
